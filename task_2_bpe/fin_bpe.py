...
class BigramLM:
    def get_tokens(self, seq):
        toks = seq.split(',')
        return [self.tok_id[tok] for tok in toks if tok]
    ...
    def save(self, filename="bigram_mdl_bpe.pkl"):
...
def load(filename="bigram_mdl_bpe.pkl"):
...
# bgram = BigramLM('tokenized_samples.txt')
# for i in range(50):
#     sent, label, score = bgram.get_emotion_score(emotion = "surprise")
#     print(label, " - ", score)
